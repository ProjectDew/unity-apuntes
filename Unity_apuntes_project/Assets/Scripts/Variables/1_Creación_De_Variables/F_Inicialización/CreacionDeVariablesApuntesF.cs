...
public class CreacionDeVariablesApuntesF : MonoBehaviour
{
	...
	// Una variable se puede inicializar a la misma vez que se declara, pero también se puede inicializar más adelante
	...
	float numeroReal = 3.14f;			// Los números float llevan detrás una letra 'f' (o 'F') y, en caso de tener decimales, se separan con un punto (no una coma)
