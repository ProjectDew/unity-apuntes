...
public class CreacionDeVariablesEjerciciosA : MonoBehaviour
{
	// -------------------------------------------------- RECOMENDACIONES --------------------------------------------------
	...
	void Ejercicio1()
	{
		// Describe en muy pocas palabras qué es lo que hacen las variables (escribe tu respuesta aquí abajo entre las comillas)
		// --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		string respuesta = "";
	...
	void Ejercicio2()
	{
		// ¿Qué es lo que hace que los datos que guardamos en variables se puedan identificar? (Escribe tu respuesta aquí abajo entre las comillas)
		// --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		string respuesta = "";
	...
	void Ejercicio3()
	{
		// ¿Cuál es el límite de veces que podemos usar una misma variable? (Escribe tu respuesta aquí abajo entre las comillas)
		// --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		string respuesta = "";
